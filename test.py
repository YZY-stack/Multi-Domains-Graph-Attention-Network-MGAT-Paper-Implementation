...
if __name__ == '__main__':
    ...
    # gpu-params
    parser.add_argument('--model_name', default='cipucnet', type=str)
    parser.add_argument('--data_compression', default='LQ', type=str)
    parser.add_argument('--model_compression', default='HQ', type=str)
    ...
    for name in dataset_name:
        ...
        test_dataset = Deepfakes(dataset_root=dataset_path, dataset_name=name, size=320,
                                 frame_num=32, mode=SAVE_FOLDER, dataAug=False)
        ...
        dataset_metric[name] = [round(roc_auc, 3), round(acc*100, 3), round(eer*100, 3)]
